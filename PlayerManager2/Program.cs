...
namespace PlayerManager2//PlayerManager1 // >>> Change to PlayerManager2 for exercise 4 <<< //
{
    /// <summary>
    ...
    public class Program
    {
        ...
        private void ShowMenu()
        {
            ...
            Console.WriteLine("2. List Every Player");
        ...
        public  IEnumerable<Player> ListPlayersWithScoreGreaterThan()
        {
            ...
            {
                // Get the players with a score greater than the specified value
